...
private DefaultTableModel model;
 ...
 private void clearForm() {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String jenis = cmbJenisToko.getSelectedItem().toString();
        String info = txtTambahan.getText();
        ...
        model.addRow(new Object[]{
            ...
            toko.getLokasi(),
            toko.getJenisStore(),
            toko.tampilkanInfoToko(true) // tampilkan versi ringkas di tabel
        });

        JOptionPane.showMessageDialog(this, toko.tampilkanInfoToko()); // versi lengkap sebagai popup
        clearForm();
