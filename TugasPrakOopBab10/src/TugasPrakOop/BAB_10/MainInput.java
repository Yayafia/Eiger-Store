...
public class MainInput {
    public static void main(String[] args) {
        ...
        try {
            ...
            TugasPrakOop.BAB8.EigerStore toko;
            ...
            if (jenis.equalsIgnoreCase("Adventure")) {
                ...
                toko = new TugasPrakOop.BAB8.EigerAdventureStore(nama, lokasi, aktivitas, musim, tambahan);
                ...
                toko = new TugasPrakOop.BAB8.EigerCasualStore(nama, lokasi, kelamin, warna, tambahan);
            } else {
