...
private DefaultTableModel model;
    ...
    public GUI_Eiger() {
        ...
        model.setColumnIdentifiers(new Object[]{"Nama Toko", "Lokasi", "Jenis Store", "Info Ringkas"});
...
private void clearForm() {
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Toko", "Lokasi", "Jenis Toko", "Info Tambahan"
            }
        ));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (row != -1) {
            model.removeRow(row);
            JOptionPane.showMessageDialog(this, "Data dihapus dari tabel. Perlu restart untuk hapus permanen di list.");
        } else {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        EigerStore toko;
        if (jenis.equals("Adventure Store")) {
            toko = new EigerAdventureStore(nama, lokasi, info, "Musim Panas", "Tambahan default");
        } else {
        ...
        JOptionPane.showMessageDialog(this, toko.tampilkanInfoToko()); // versi lengkap
        clearForm();
    ...
    private void btnLihatSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLihatSemuaActionPerformed
        // TODO add your handling code here:
        model.setRowCount(0); // clear table sebelum menampilkan
        for (EigerStore toko : EigerStore.getDaftarToko()) {
            model.addRow(new Object[]{
                toko.getNamaToko(),
                toko.getLokasi(),
                toko.getJenisStore(),
                toko.tampilkanInfoToko(true) // versi singkat (overload)
            });
        }
